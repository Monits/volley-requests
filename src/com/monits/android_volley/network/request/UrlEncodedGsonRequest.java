...
public class UrlEncodedGsonRequest<T> extends UrlEncodedRfcCompliantListenableRequest<T> {

	private final Gson gson;
	private final Type clazz;

	public UrlEncodedGsonRequest(final int method, final String url, final Gson gson,
